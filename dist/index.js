...
var React360Viewer = /*#__PURE__*/function (_Component) {
  ...
  function React360Viewer() {
    ...
    _defineProperty(_assertThisInitialized(_this), "zoomIn", function (evt) {// this.setState({ 
      //     lastX: this.centerX,
      //     lastY: this.centerY
      // })
    ...
    _defineProperty(_assertThisInitialized(_this), "zoomOut", function (evt) {// this.setState({ 
      //     lastX: this.centerX,
      //     lastY: this.centerY
      // })
      // this.zoom(-2)
    ...
    _defineProperty(_assertThisInitialized(_this), "handlePinch", function (e) {// if (e.scale < this.currentScale) {
      // // zoom in
      //     // this.zoomIn();
  ...
  _createClass(React360Viewer, [{
    ...
    key: "zoom",
    value: function zoom(clicks) {// //console.log(this.lastX + ' - ' + this.lastY)
    ...
    value: function render() {
      ...
      })) : '', /*#__PURE__*/_react.default.createElement(_reactHammerjs.default, {
